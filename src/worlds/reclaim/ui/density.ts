...
//   산문 16px(text-base) · 행간 1.75(--leading-prose 오버라이드).
//   **확정 간격 부분집합은 4·8·12·16·24·32**다(구역 간격 24, 화면 여백 16, 구역 안쪽 8,
//   목록 표시 자리 16). 이 목록 밖의 값이 화면에 나타나면 토큰 드리프트다 — 주변을 패치하지 말고
